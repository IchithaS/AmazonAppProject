...
public class Test {
	...
	public static void main(String[] args) throws InterruptedException {
	  ...
	  //implicit wait
		...
		test.log(Status.PASS, "Maximxing the window");
		
	   // Open Google
		driver1.get("https://www.google.com");
	    Thread.sleep(1000);
	    test.log(Status.PASS, "Url has been launched(chrome browser)");
        Thread.sleep(2000);
        
       //opening Amazon
        driver1.get("https://www.amazon.com");
        Thread.sleep(1000);
        test.log(Status.PASS, "Amazon Website Opened");
       ...
       //searching for product
        ...
        switchToWindow();
        Thread.sleep(2000);
        test.log(Status.PASS, "Searching and selecting the Product Mobile done succesfully");
       ...
       ((JavascriptExecutor)driver1).executeScript("arguments[0].click()",addcart);
        ...
        Thread.sleep(1000);
        test.log(Status.PASS, "Product has been added to cart(mobile)");
     ...
     //purchasing Laptop
       ...
       switchToWindow();
       test.log(Status.PASS, "Searching and selecting for new product Laptop");
       Thread.sleep(1000);
      ...
      //add to cart
       ...
       driver1.findElement(By.id("attach-close_sideSheet-link")).click();
       driver1.get("https://www.amazon.in/gp/cart/view.html?ref_=nav_cart");
       test.log(Status.PASS, "Laptop product has been added to cart");
       Thread.sleep(1000);
      ...
      //driver1.findElement(By.xpath("//span[@id='submit.add-to-cart-announce' and contains(text(),'Add to Cart')]")).click();
       ...
       //Closing window
       driver1.close();
       test.log(Status.PASS, "Window has closed");
      //closing report
       extent.flush();
       driver1.quit();
